...
<head>
    ...
    <title>Cashier Office — Reports</title>
    <link rel="icon" href="img/btc-w.png">
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.0/css/bootstrap.min.css" integrity="sha384-9gVQ4dYFwwWSjIDZnLEWnxCjeSWFphJiwGPXr1jddIhOegiu1FwO5qRGvFXOdJZ4" crossorigin="anonymous">
    <link rel="stylesheet" href="{{asset('css/cashier/reports.css')}}">
        ...
        <div class="small-icons">
          ...
          <a href="#"><i class="fas fa-sign-out-alt"></i></a>
            ...
            <li >
                ...
                <li>
                    <a href="paymentList.html" data-toggle="tooltip" data-placement="right" title="MasterList">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<i class="fas fa-address-book icon"></i>&nbsp&nbsp&nbsp&nbsp&nbsp Payment List</a>
                </li>
                <li class="active">
...
<div class="modal fade" id="notifications" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="card-deck">
                <div class="card">
                  <img class="card-img-top" src="{{asset('img/cashier/btc-g.png')}}" alt="Card image cap">
                  <div class="card-body">
                    <h5 class="card-title">Daily Collection Report for March 15, 2019</h5>
                  </div>
                  <div class="confBttns">
                  ...
                  <div class="card-footer">
                    <small class="text-muted">Generated last March 16, 2019 at 12:00 am </small>
                  </div>
                </div>
                <div class="card">
                        <img class="card-img-top" src="{{asset('img/cashier/btc-g.png')}}" alt="Card image cap">
                        <div class="card-body">
                          <h5 class="card-title">Daily Collection Report for March 14, 2019</h5>
                        </div>
                        <div class="confBttns">
                            <a href="#" class="btn btn-primary"id="view">View</a>
                            <a href="#" class="btn btn-primary" id="download">Download</a>
                        ...
                        <div class="card-footer">
                          ...
                          <small class="text-muted">Generated last March 15, 2019 at 12:00 am</small>
                        </div>
                      </div>
                      <div class="card">
                            <img class="card-img-top" src="{{asset('img/cashier/btc-g.png')}}" alt="Card image cap">
                            ...
                            <div class="card-footer">
                              <small class="text-muted">Generated last March 14, 2019 at 12:00 am</small>
                            </div>
                          </div>
              </div>
    <!-- Popper.JS -->
