...
<head>
    ...
    <title>Cashier Office — Settings</title>
    ...
    <link rel="stylesheet" href="{{asset('css/cashier/settings.css')}}">
                    ...
                    <div class="col-12 mt-3">
                        <div class="card">
                            <div class="card-horizontal">
                                    <img class="user-icon" src="{{asset('img/cashier/btc-g.png')}}" alt="Card image cap">
                                <div class="card-body">
                                    <h4 class="card-title">April Joy Q. Castillo</h4>
                                    <p class="card-text">001235
                                      <br>Reservation Office
                                      <div class="row">
