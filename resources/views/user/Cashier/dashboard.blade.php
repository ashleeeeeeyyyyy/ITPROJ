...
<html>
    <head>
        ...
        <script src="{{asset('js/cashier/jquery.sticky.js')}}"></script>
        ...
        <div class="small-icons">
          ...
          <a href="#"><i class="fas fa-sign-out-alt"></i></a>
            ...
            <li class="active">
                ...
                <li>
                    <a href="paymentlist.html" data-toggle="tooltip" data-placement="right" title="Reports">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<i class="fas fa-address-book icon"></i>&nbsp&nbsp&nbsp&nbspPayment List</a>
                </li>
                <li>
                ...
                <li>
                    <a href="history.html" data-toggle="tooltip" data-placement="right" title="History">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<i class="fas fa-history icon"></i>&nbsp&nbsp&nbsp History</a>
                </li>
                <li>
        ...
        <div class="modal-body">
          ...
                ...
                <div class="card-deck" id="assessmentCard" >
                    ...
                    <div class="card text-white bg-warning mb-3" id="upCard"> 
                        <div class="card-header" id="uheader">Unpaid</div>
                        ...
                        <div class="card text-white bg-success mb-3" id="paidCard">
                        <div class="card-header" id="pheader">Paid</div>
                ...
                <form class="form-inline">
                    ...
                    <select class="custom-select my-1 mr-sm-2" id="filterBy">
                      ...
                      <option value="4">Accounts Receivable</option>
                        ...
                        <input type="text" class="form-control" placeholder="Payment information" aria-label="search for facilities" aria-describedby="basic-addon2" id="search">
                ...
                <!-- Facilities -->
                  <div class="card-deck">
                    <div class="card">
                      <img class="card-img-top" src="{{asset('img/cashier/icon.svg')}}" alt="Card image cap">
                      <div class="card-body">
                    ...
                    <div class="card">
                      <img class="card-img-top" src="img/icon.svg" alt="Card image cap">
                      <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                      </div>
                    </div>
