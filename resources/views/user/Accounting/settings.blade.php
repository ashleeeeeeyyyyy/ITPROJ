...
<head>
    ...
    <title>Reservation Office — Settings</title>
    ...
    <link rel="stylesheet" href="{{asset('css/accounting/settings.css')}}">
    ...
    <div class="small-icons">
      ...
      <a href="#"><i class="fas fa-sign-out-alt"></i></a>
        ...
        <li>
            ...
            <li>
                <a href="reservation.html" data-toggle="tooltip" data-placement="right" title="Assessments">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<i class="fas fa-receipt icon"></i>&nbsp&nbsp&nbsp&nbsp&nbsp&nbspAssessments</a>
            </li>
            <li>
                    ...
                    <div class="col-12 mt-3">
                        <div class="card">
                            <div class="card-horizontal">
                                    <img class="user-icon" src="{{asset('img/accounting/btc-g.png')}}" alt="Card image cap">
                                <div class="card-body">
