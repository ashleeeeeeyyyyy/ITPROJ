...
<head>
    ...
    <link rel="icon" href="{{asset('img/supervisor/btc-w.png')}}">
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.0/css/bootstrap.min.css" integrity="sha384-9gVQ4dYFwwWSjIDZnLEWnxCjeSWFphJiwGPXr1jddIhOegiu1FwO5qRGvFXOdJZ4" crossorigin="anonymous">
    <link rel="stylesheet" href="{{asset('css/supervisor/dashboard.css')}}">
    <link rel="stylesheet" href="{[asset('css/supervisor/reports.css')}}">
    <link rel="stylesheet" href="{{asset('css/fullcalendar/fullcalendar.css')}}">
    <script src="{{asset('lib/supervisor/jquery.min.js')}}"></script>
    <script src="{{asset('lib/supervisor/moment.min.js')}}"></script>
    <script src="{{asset('js/supervisor/fullcalendar.js')}}"></script>
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            <div class="text-center">
                <img src="{{asset('img/supervisor/icon.svg')}}" class="rounded mx-auto d-block" alt="User Picture">
        ...
        <div id="content">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <img src="{{asset('img/supervisor/btc-w.png')}}" id="logo">
                </div>
            </nav>
...
<div class="modal fade" id="notifications" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="card-deck">
                <div class="card">
                  <img class="card-img-top" src="{{asset('img/supervisor/btc-g.png')}}" alt="Card image cap">
                  <div class="card-body">
                    <h5 class="card-title">Reservation Office Accommodation Report for March 2019</h5>
                  </div>
                  <div class="confBttns">
                ...
                <div class="card">
                        <img class="card-img-top" src="{{asset('img/supervisor/btc-g.png')}}" alt="Card image cap">
                        <div class="card-body">
                          <h5 class="card-title">Front Desk Accommodation Report for March 2019</h5>
                        </div>
                        <div class="confBttns">
                          <a href="#" class="btn btn-primary"id="view">View</a>
                          <a href="#" class="btn btn-primary" id="download">Download</a>
                      ...
                      <div class="card">
                            <img class="card-img-top" src="{{asset('img/supervisor/btc-g.png')}}" alt="Card image cap">
                            <div class="card-body">
                              <h5 class="card-title">Reservation Office Accommodation Report for February 2019</h5>
                            </div>
                            <div class="confBttns">
                              <a href="#" class="btn btn-primary"id="view">View</a>
                              <a href="#" class="btn btn-primary" id="download">Download</a>
                            ...
                            <div class="card-footer">
                              <small class="text-muted">Generated last March 01, 2019 at 12:00 am</small>
                            </div>
                          </div>
              </div>
    <!-- Popper.JS -->
