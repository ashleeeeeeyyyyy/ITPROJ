...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/supervisor/settings.css')}}">
    ...
    <script src="{{asset('js/supervisor/jquery.sticky.js')}}"></script>
                    ...
                    <div class="col-12 mt-3">
                        <div class="card">
                            <div class="card-horizontal">
                                    <img class="user-icon" src="{{asset('img/supervisor/btc-g.png')}}" alt="Card image cap">
                                <div class="card-body">
                                    <h4 class="card-title">Kenneth M. Mabanglo</h4>
                                    <p class="card-text">00123336
                                      <br>Supervisor
                                      <div class="row">
