...
<html>
  <head>
    ...
    <title>Reservation Office — Reports</title>
    <link rel="icon" href="{{asset('img/reservation/btc-w.png')}}">
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.0/css/bootstrap.min.css" integrity="sha384-9gVQ4dYFwwWSjIDZnLEWnxCjeSWFphJiwGPXr1jddIhOegiu1FwO5qRGvFXOdJZ4" crossorigin="anonymous">
    <link rel="stylesheet" href="{{asset('css/reservation/reports.css')}}">
  ...
  <body>
    <div class="wrapper">
      ...
      <div id="content">
        ...
        <div class="card-deck">
          <div class="card">
            <img class="card-img-top" src="{{asset('img/reservation/btc-g.png')}}" alt="Card image cap">
            <div class="card-body">
          ...
          <div class="card">
            <img class="card-img-top" src="{{asset('img/reservation/btc-g.png')}}" alt="Card image cap">
            <div class="card-body">
              <h5 class="card-title">Reservation Office Accommodation Report for January 2019</h5>
            </div>
